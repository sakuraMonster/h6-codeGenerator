 ...
 * @author zhangxuejun
 */
public class NewSelectSavePath extends DialogWrapper {
  /**
   * 主面板
   */
   ...
   * 构造方法
   */
  public NewSelectSavePath(Project project) {
    this(project, false);
  }
   ...
   * 构造方法
   */
  public NewSelectSavePath(Project project, boolean entityMode) {
    super(project);
...
//    }
  ...
  private void onOK() {
    ...
    String sourceSql = sqlText.getText();
    if(StringUtils.isEmpty(sourceSql)) {
      Messages.showWarningDialog("Can't Input SourceSql", GlobalDict.TITLE_INFO);
      return;
    }
