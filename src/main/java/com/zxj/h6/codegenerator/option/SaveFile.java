...
public class SaveFile {
     ...
     */
    public SaveFile(Project project, String content, Callback callback,  GenerateOption generateOptions) {
        this.project = project;
        this.callback = callback;
        this.content = content.replace("\r", "");
        this.generateOption = generateOptions;
    }
    ...
    private VirtualFile titleCreateDir(VirtualFile saveDir, VirtualFile baseDir, String savePath) {
        ...
        if (generateOption.getTitleSure()) {
            saveDir = fileUtils.createChildDirectory(project, baseDir, savePath);
            return saveDir;
        } else if (generateOption.getTitleRefuse()) {
            return null;
        } else {
